...
@app.route('/')
def index(nf=False):
    return render_template('index.html', not_found=nf)
...
def results():
    ...
    def retrieving_tweets_polarity(symbol):
        ...
        print(stock_full_form['Name'])
        print(stock_full_form['Name'].to_list()[0])
        ...
        tweets = tweepy.Cursor(
            user.search_tweets, q=symbol, tweet_mode='extended', lang='en'
    ...
    try:
        ...
        return render_template(
            'results.html', quote=quote, arima_pred=round(arima_pred, 2), lstm_pred=round(lstm_pred, 2),
